...
void Widget::paintEvent(QPaintEvent *event)
{
    ...
    painter.drawRect(10,10,100,100);  //Draw with default SolidLine

    //Qt::NoPen
    mPen.setStyle(Qt::NoPen);
    painter.setPen(mPen);
    painter.drawRect(120,10,100,100);  //Draw with Qt::NoPen

    //Qt::DashLine
    mPen.setStyle(Qt::DashLine);
    painter.setPen(mPen);
    painter.drawRect(230,10,100,100); //Draw with Qt::DashLine

    //Qt::DotLine
    mPen.setStyle(Qt::DotLine);
    painter.setPen(mPen);
    painter.drawRect(340,10,100,100);  //Draw with Qt::DotLine

    //Qt::DashDotLine
    mPen.setStyle(Qt::DashDotLine);
    painter.setPen(mPen);
    painter.drawRect(450,10,100,100); //Draw with Qt::DashDotLine
